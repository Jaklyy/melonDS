...
void SoftRenderer::RenderPolygonScanline(const GPU& gpu, RendererPolygon* rp, s32 y)
{
    ...
    s32 sl = interp_start->Interpolate(vlcur->TexCoords[0]>>8, vlnext->TexCoords[0]>>8);
    s32 tl = interp_start->Interpolate(vlcur->TexCoords[1]>>8, vlnext->TexCoords[1]>>8);
    ...
    s32 sr = interp_end->Interpolate(vrcur->TexCoords[0]>>8, vrnext->TexCoords[0]>>8);
    s32 tr = interp_end->Interpolate(vrcur->TexCoords[1]>>8, vrnext->TexCoords[1]>>8);
